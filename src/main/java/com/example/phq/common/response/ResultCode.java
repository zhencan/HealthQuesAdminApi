package com.example.phq.common.response;
...
public enum ResultCode {
    ...
    /*  手机错误： */
    SMS_PHONE_FORMAT_INCORRECT(80001,"手机号码格式不正确"),
    SMS_PHONE_NUMBER_INVAILD(80002, "手机号码不正确"),
    SMS_PHONE_SEND_OFTEN(80003, "发送短信频繁"),
    SMS_PHONE_CODE_SEND_FAILURE(80004, "短信验证码发送失败"),
    SMS_PHONE_CODE_INVAILD(80005, "短信验证失败");
